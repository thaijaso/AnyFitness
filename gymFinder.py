...
mysql = MySQL()
app = Flask(__name__)
app.config['MYSQL_DATABASE_USER'] = 'tarriola'
app.config['MYSQL_DATABASE_PASSWORD'] = 'RikTeric'
app.config['MYSQL_DATABASE_DB'] = 'tarriola'
app.config['MYSQL_DATABASE_HOST'] = 'cssgate.insttech.washington.edu'
